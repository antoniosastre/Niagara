...
echo "<form action=\"materials.php?sm=".$_GET["em"]."\" method=\"post\" id=\"editmaterial\">";
...
echo "<form action=\"materials.php\" method=\"post\" id=\"newmaterial\">";
...
<?php 
 ...
 echo "<tr>
 <td><a href=\"materials.php?dm=".$material['id']."\"><img src=\"img/trash.png\" height=\"20\" width=\"20\"></a> <a href=\"materials.php?em=".$material['id']."\"><img src=\"img/edit.png\" height=\"16\" width=\"16\"></a></td>
 <td>".$material['name']."</td>
 <td>".$material['type']."</td>
